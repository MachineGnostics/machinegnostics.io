...
def main():
    ...
    render_mg_hero(
        "Gnostic Polynomial Regression",
        "Fit a robust polynomial model with multivariate features, visualize partial predictions, inspect automatic weights, and analyze training history.",
    )
