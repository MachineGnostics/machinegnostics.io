...
|-------------|--------------------------------|---------------------------------------------------------------------------------------------|--------------|
| `y_true`    | array-like or Pandas Series    | True values (targets).                                                                     | Required     |
| `y_pred`    | array-like or Pandas Series    | Predicted values.                                                                          | Required     |
...
- **TypeError**  
  If inputs are not array-like (NumPy arrays, lists) or Pandas Series.
- **ValueError**  
...
- **TypeError**  
  If inputs are not array-like (NumPy arrays, lists) or Pandas Series, or `n_features` is not a non-negative integer.
- **ValueError**  
...
- If you pass a pandas DataFrame, select a column (e.g., df['col']), not the whole DataFrame.
